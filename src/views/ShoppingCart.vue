                                ...
                                <div class="user-checkout text-left">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="customerInfo.name" class="form-control" id="namaLengkap" aria-describedby="namaHelp" placeholder="Masukan Nama">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="customerInfo.number" class="form-control" id="noHP" aria-describedby="noHPHelp" placeholder="Masukan No. HP">
                                        </div>
                                        <div class="form-group">
